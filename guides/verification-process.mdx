...
- **Business Verification Guide**
    ...
    ![image.png](/images/guides/verification-process/image%205.png)
    
    Step 2: Click on Verify Business button and the Business Verification form will open 
    
    ![image.png](/images/guides/verification-process/image%206.png)
    
    Step 3: Fill all the details accurately and submit the form 
    
    ![image.png](/images/guides/verification-process/image%207.png)
    
    Step 4 : After form submission, you can view the verification status on the dashboard (Pending)
    
    ![image.png](/images/guides/verification-process/image%208.png)
...
2. **Contact the Verification Team**:
    - If you believe the rejection was a mistake or if you have additional information to clarify your case, you can contact our support team for guidance on how to proceed.
