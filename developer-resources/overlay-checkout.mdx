...
DodoPayments.Checkout.open({
  checkout_url: "https://checkout.dodopayments.com/session/cks_123" // Get this url from create checkout session api
});
```
...
| Option | Type | Required | Description |
|--------|------|----------|-------------|
| `checkout_url` | string | Yes | Checkout session URL from create checkout session API |
