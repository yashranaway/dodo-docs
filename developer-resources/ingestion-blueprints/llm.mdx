---
title: "LLM Blueprint"
description: "Effortlessly track LLM token usage for usage-based billing with automatic ingestion to Dodo Payments. Works with OpenAI, Anthropic, Groq, and AI SDK."
icon: "brain-circuit"
---
