...
<CodeGroup>
```typescript server/routes/api/checkout.get.ts
...
<CodeGroup>
```typescript server/routes/api/checkout.post.ts
...
<CodeGroup>
```typescript server/routes/api/customer-portal.get.ts
...
<CodeGroup>
```typescript server/routes/api/webhook.post.ts
