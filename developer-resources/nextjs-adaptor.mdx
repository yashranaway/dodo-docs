...
description: "Learn how to integrate Dodo Payments with your Next.js App Router project using our NexJS Adaptor. Covers checkout, customer portal, webhooks, and secure environment setup."
icon: "code"
---
...
<Tab title="Checkout Handler">
  ...
  <CodeGroup>
  ```curl Static Checkout Curl example
  curl --request GET \
...
<Tab title="Customer Portal Handler">
  ...
  <CodeGroup>
  ```curl Customer Portal Curl example
  curl --request GET \
...
<Info>
Copy and paste the following prompt into your LLM or assistant to get step-by-step integration guidance.
</Info>
