...
- **Metadata in Static Payment Links**: Added support for metadata in static payment links. For more details, refer to the [documentation](/api-reference/integration-guide#1-static-payment-links).
