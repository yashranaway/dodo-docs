...
<Tab title="Boilerplates & Starters">
  <CardGroup cols={1}>
    ...
    <Card title="DodoStarter Boilerplate" href="https://github.com/AINotSoSmart/dodostarter" icon="code">
      A brutally simple Next.js boilerplate with supabase auth and a clean one-time dodopayemnts setup. 
      <br/>Go from a blank folder to a working app this afternoon
      <br/>By <a href="https://github.com/KissuChaudhary">@KissuChaudhary</a>
