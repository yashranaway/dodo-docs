...
<Card title="Business Profile" horizontal icon="briefcase" href="/guides/business-profile">
  Process to update Business Profile details
</Card>

## **User Account**

Merchant can access their User Profile and edit their personal information such as Contact Name, Profile Image and phone number for a more personalized experience.

<Card title="User Profile" horizontal icon="user" href="/guides/user-profile">
