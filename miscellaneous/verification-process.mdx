...
At Dodo Payments, we require all merchants to complete a thorough verification process to ensure compliance with regulatory standards and platform policies. This process covers **Identity Verification**, **Business Verification**, and strict checks on **AML (Anti-Money Laundering)** and **Product Category** compliance.

<Info>
For the most up-to-date and comprehensive details on supported and prohibited product categories, as well as restricted and accepted merchant locations, please refer to our <a href="/miscellaneous/merchant-acceptance" rel="noopener">Merchant Acceptance Policy</a>.
</Info>
