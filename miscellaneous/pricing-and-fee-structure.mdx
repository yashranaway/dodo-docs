...
**This refers to the fees applied on the transaction made by customers**&#x20;

### **For Customers in the USA**

* **Transaction Fee**: 4% of the transaction amount + $0.40 per transaction.
...
* **Transaction Fee**: 4% + 1.5% of the transaction amount + $0.40 per transaction.

* **Additional Notes**: This applies to credit/debit card and local payments for customers based outside of the USA&#x20;

### **For Subscription Payments**

* **Transaction Fee**: Additional 0.5% of the transaction amount will be applied as surcharge for subscription payments
