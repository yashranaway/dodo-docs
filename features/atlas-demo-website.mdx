...
description: The **Atlas Demo Product** is a demo site by **Dodo Payments** that showcases how **digital products** (like software licenses, digital downloads, or online memberships) can be sold using our **checkout** solution. Merchants can see both **subscription** and **one-time purchase** flows in action.
icon: "box"
---
...
<Frame>
  <iframe 
      ...
      src="https://www.youtube.com/embed/eOiH_qL_5oI"
      title="Atlas Demo Product | Dodo Payments"
      frameBorder="0"
...
Follow this guide for integration: [Guide](/api-reference/integration-guide)
