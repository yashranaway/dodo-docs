...
2. **UPI Details**
    - The customer enters their **UPI ID** on the checkout page or chooses to scan **UPI QR** code.
...
3. **Test UPI**
    - The checkout page provides test UPI IDs in the view test payment methods section along with option to scan UPI QR code.
