...
5. 📝 **Transaction Record**
   ...
   - Adaptive pricing fees and converted values are abstracted from the merchant view
...
- ⚠️ This means that you might pay more or less to cover the refund depending on how the exchange rate changes
...
5. We deduct 97.86 USD from your account, exchanging it at 1.40 CAD per 1 USD to pay out the 137 CAD refund
