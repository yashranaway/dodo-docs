...
### **1. Credit Cards**
<Frame><img alt="Accepted Cards"  src="/images/transactions/payments/cards.png"/> </Frame>
...
<Frame><img  alt="wallets" src="/images/transactions/payments/wallet.png"/> </Frame>
...
### **4.Upi and Rupay**
<Frame><img  src="/images/transactions/payments/indian-methods.png"/> </Frame>
...
- **Additional Payment Methods**: We are constantly adding more payment methods to our roster. We will keep updating this page as and when we add more methods. If you have a requirement for any particular payment method, please write to us at support@dodopayments.com and we will add this to our roadmap if not present.
