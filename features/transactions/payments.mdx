...
<Card title="Payment Methods Accepted" horizontal icon="credit-card" href="/features/payment-methods">Overview of the payment methods accepted by Dodo Payments</Card>
