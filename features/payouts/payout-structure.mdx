...
- **Payout Schedule**
    1. Payouts cycle will be monthly. It will start from the 1st of every month to the end of the month. Even if the merchant is onboarded on any date, billing period will still be the same
    2. Payouts will be processed on or before the 15th of every month for the previous month's billing cycle
- **Payout Currency**
...
- **Payout Deductions**
    ...
    2. Dodo Payment Fees and Payout Fees will be deducted before sending the payout. For details check out our [Pricing Page](/miscellaneous/pricing-and-fees-structure)
