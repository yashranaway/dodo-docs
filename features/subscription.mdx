...
<Info>
  Changes to a subscription product only apply to new subscribers. Existing customers keep their current pricing and terms unless you manually upgrade or downgrade their subscription. To update pricing for current subscribers, adjust their plan individually.
</Info>
...
<Frame>
  ![Mandate Creation Flow](/images/subscriptions/mandate-creation.png)
</Frame>

<Frame>
  ![Payment Renewal Flow](/images/subscriptions/payment-renewal.png)
</Frame>
