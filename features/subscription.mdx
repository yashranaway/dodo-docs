...
For subsequent charges, use the [POST /subscriptions/charge](/api-reference/misc/charge-subscriptions) endpoint and specify the amount to charge the customer for that transaction.
