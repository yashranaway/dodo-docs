...
| **Affirm (BNPL)**       | US                  | USD                  | $50.01     | -          | Not available for subscriptions |
| **Klarna (BNPL)**       | US                  | USD                  | $50.01     | -          | Not available for subscriptions |
| **UPI (QR/ID)**         | India               | INR                  | -          | -          |                           |
| **Rupay (Credit/Debit)**| India               | INR                  | -          | -          |                           |
...
*   **Klarna** - A leading Buy Now, Pay Later (BNPL) service that offers flexible payment options including pay in 4 installments, pay in 30 days, and financing solutions, with a strong presence in Europe and North America.
*   **Affirm** - A modern BNPL platform that provides transparent installment payment plans with no hidden fees, allowing customers to split purchases into fixed monthly payments with clear terms and conditions.
