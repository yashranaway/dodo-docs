---
titile: Subscription
description: The Subscription Products feature in Dodo Payments allows merchants to offer products and services that are billed on a recurring basis, such as monthly memberships, SaaS (Software-as-a-Service) plans, or recurring deliveries. This feature provides flexibility in setting up pricing, billing cycles, and even free trials, making it ideal for businesses looking to offer ongoing services or products.
---

## Add a Subscription Product

Merchants can create subscription-based products for services that require recurring payments, such as software subscriptions, content memberships, or subscription boxes. This is a powerful way to generate consistent revenue while providing ongoing value to your customers.
...
4. **Enter Subscription Details**:
    ...
    - **Pricing**: Set the recurring price (e.g., $10/month or $100/year).
...
<Info>Changes to subscription pricing or terms will only affect new customers or future subscription renewals. Existing subscribers will continue with their current terms unless you manually update their subscription.</Info>
...
<Info>Deleting a subscription product will not affect existing subscribers. They will continue to receive the subscription on the terms they initially agreed to unless you manually cancel their subscriptions.</Info>

## Subscription Product Step by Step Guide

### Step 1

Click Add Product button

![Add Product button image](/images/product-catalog/subscription/1.png)

### Step 2

Enter Product Details

![Enter Product Details image](/images/product-catalog/subscription/2-3.png)

### Step 3

Select Pricing type as Subscription

![Select Pricing type as Subscription image](/images/product-catalog/subscription/2-3.png)

### Step 4

Enter all subscription details and click add product

![Enter all subscription details and click add product image](/images/product-catalog/subscription/4.png)

### Step 5

Product is added to your catalog

![Product is added to your catalog image](/images/product-catalog/subscription/5.png)