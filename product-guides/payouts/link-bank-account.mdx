...
Open Settings Page → Payouts Tab 

![Payouts Tab](/images/payouts/1.png)

### Step 2

Click on Add button and Bank Information form will open 

![Bank Information form](/images/payouts/2.png)

### Step 3

Fill all the details accurately and submit the form 

![Fill Bank Information form](/images/payouts/3.png)

### Step 4

After form submission, refresh and you can view the status on the dashboard 

![View status on dashboard](/images/payouts/4.png)
