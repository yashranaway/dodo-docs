...
**Overview**
  ...
  **How It Works**
    ...
    [Add Identity verification Guide](/guides/identity-verification)

    [Add Business Verification Guide](/guides/business-verification)

    For More details about the Verification process visit the [verification guide](/miscellaneous/verification-process)
  </Accordion>

  <Accordion title="Step 3: Add Your First Product">
  - [One Time Payment Product Guide](/guides/one-time-product)
  - [Subscription Product Guide](/guides/subscription-product)
  </Accordion>
  <Accordion title="Step 4: Create a payment link">
  - [Payment link creation Guide](/guides/payment-links-guide)
  </Accordion>
  <Accordion title="Step 5: Payout Setup">
  - [Link your bank account Guide](/guides/bank-account)
  - [Payout Compliance Guide](/guides/payout-compliance)
  </Accordion>
</AccordionGroup>