...
<AccordionGroup>
<Accordion title="Show All 10 Supported Frameworks">
  <CardGroup cols={4}>
...
<CardGroup cols={4}>
  <Card title="TypeScript" icon="code-simple" href="/developer-resources/dodo-payments-sdks">
    Full-featured TypeScript SDK with complete type safety
  </Card>
  
  <Card title="Python" icon="python" href="/developer-resources/dodo-payments-sdks">
    Python SDK for backend services and data science
  </Card>
  
  <Card title="Go" icon="golang" href="/developer-resources/dodo-payments-sdks">
    High-performance Go SDK for microservices
  </Card>
  
  <Card title="PHP" icon="php" href="/developer-resources/dodo-payments-sdks">
    PHP SDK for web applications
  </Card>
  <Card title="Java" icon="java" href="/developer-resources/dodo-payments-sdks">
    Java SDK for enterprise applications
  </Card>

  <Card title="Kotlin" icon="android" href="/developer-resources/dodo-payments-sdks">
    Kotlin SDK for Android development
  </Card>

  <Card title="C#" icon="hashtag" href="/developer-resources/dodo-payments-sdks">
    C# SDK for .NET applications
  </Card>

  <Card title="Ruby" icon="gem" href="/developer-resources/dodo-payments-sdks">
    Ruby SDK for web applications
  </Card>
</CardGroup>
