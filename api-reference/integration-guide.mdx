...
For a seamless in-page checkout experience, explore our [Overlay Checkout](/api-reference/overlay-checkout) integration that allows customers to complete payments without leaving your website.
