...
- 🎥 Watch our [demo video](https://github.com/dodopayments/dodopayments-react-native-demo/tree/main/demo) to see the Dodo Payments SDK in action
...
<Step title="Setup Payment Provider">
    ...
    <Note>
    You'll need to generate API keys from your Dodo Payments dashboard. See our [API key generation guide](/guides/api-key-generation) for detailed instructions.
    </Note>
</Step>
...
<Step title="Create payment utility function">
    ...
    <Note>
    This function assumes you have a backend API endpoint that creates payment intents and returns a client secret. Ensure your backend is properly configured to handle payment creation. See our [API Integration Tutorial](/api-reference/integration-tutorial) for backend setup examples.
    </Note>
</Step>
...
<Step title="Implement the payment screen">
    ...
    - [Basic Integration Demo](https://github.com/dodopayments/react-native-demo)
    </Note>
</Step>
</Steps>
