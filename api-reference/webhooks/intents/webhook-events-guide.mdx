...
| **Subscription On Hold** | `subscription.on_hold`   | Triggered when a subscription is temporarily put on hold.                       |
...
| **Subscription Failed**  | `subscription.failed`    | Indicates a failed subscription renewal payment.                                |
