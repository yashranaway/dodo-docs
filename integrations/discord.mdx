...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/discord/1.png" alt="Add Endpoint and integrations dropdown" />
  </Frame>
</Step>
...
<Step title="Select Discord">
  ...
  <Frame>
    <img src="/images/integrations/discord/2.png" alt="Discord integration card" />
  </Frame>
</Step>
...
<Step title="Authorize the Bot">
  ...
  <Frame>
    <img src="/images/integrations/discord/3.png" alt="Discord OAuth permissions screen" />
  </Frame>
</Step>
...
<Step title="Edit Transformation Code">
  ...
  <Frame>
    <img src="/images/integrations/discord/4.png" alt="Transformation code editor" />
  </Frame>
</Step>
...
<Step title="Test & Create">
  ...
  <Frame>
    <img src="/images/integrations/discord/5.png" alt="Test transformation and create" />
  </Frame>
</Step>
  ...
  if (webhook.eventType === "payment.succeeded") {
    ...
    webhook.payload = {
      embeds: [{
        ...
        description: `**Amount:** $${p.total_amount}\n**Customer:** ${p.customer.email}`,
    ...
    webhook.payload = {
      embeds: [{
        ...
        fields: [
          ...
          { name: "Amount", value: `$${d.amount}`, inline: true },
