...
<Tabs>
<Tab title="Overlay (Embedded)">
Checkout appears as an overlay within your Framer project, keeping users on your site.
</Tab>

<Tab title="Hosted">
Users are redirected to a Dodo Payments hosted checkout page for a streamlined experience.
</Tab>
</Tabs>
