      ...
      webhook.payload = {
        attachments: [{
          ...
          fields: [
            ...
            {
              title: "Amount",
              value: `$${webhook.payload.data.recurring_pre_tax_amount}/${webhook.payload.data.payment_frequency_interval}`,
              short: true
            },
            {
              title: "Next Billing",
      ...
      webhook.payload = {
        attachments: [{
          ...
          fields: [
            ...
            {
              title: "Amount",
              value: `$${webhook.payload.data.recurring_pre_tax_amount}`,
              short: true
            },
            {
              title: "Next Billing",
...
function handler(webhook) {
  ...
  switch (webhook.eventType) {
    case "payment.succeeded":
      ...
      fields = [
        { title: "Amount", value: `$${event.total_amount}`, short: true },
    ...
    case "subscription.active":
      ...
      fields = [
        ...
        { title: "Amount", value: `$${event.recurring_pre_tax_amount}/${event.payment_frequency_interval}`, short: true },
